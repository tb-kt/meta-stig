...
echo "Configuring SSH to use FIPS-approved ciphers..."

# Ensure Ciphers is set to the FIPS-approved ciphers
grep -q "^Ciphers" "$SSH_CONFIG_FILE" && sed -i 's/^Ciphers.*/Ciphers aes256-ctr,aes256-gcm@openssh.com,aes192-ctr,aes128-ctr,aes128-gcm@openssh.com/' "$SSH_CONFIG_FILE" || echo "Ciphers aes256-ctr,aes256-gcm@openssh.com,aes192-ctr,aes128-ctr,aes128-gcm@openssh.com" >> "$SSH_CONFIG_FILE"
