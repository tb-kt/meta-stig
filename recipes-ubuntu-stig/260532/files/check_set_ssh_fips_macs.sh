...
echo "Configuring SSH to use FIPS-approved MACs..."

# Ensure MACs are set to the FIPS-approved list
grep -q "^MACs" "$SSH_CONFIG_FILE" && sed -i 's/^MACs.*/MACs hmac-sha2-512,hmac-sha2-512-etm@openssh.com,hmac-sha2-256,hmac-sha2-256-etm@openssh.com/' "$SSH_CONFIG_FILE" || echo "MACs hmac-sha2-512,hmac-sha2-512-etm@openssh.com,hmac-sha2-256,hmac-sha2-256-etm@openssh.com" >> "$SSH_CONFIG_FILE"
