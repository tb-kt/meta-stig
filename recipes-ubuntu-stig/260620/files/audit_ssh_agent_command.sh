...
# Description: This script configures the audit system to generate audit records for the use of the ssh-agent command.
...
# Add audit rule for ssh-agent command
echo "Adding audit rule for ssh-agent command."
...
echo "Audit rule for ssh-agent command added successfully."
